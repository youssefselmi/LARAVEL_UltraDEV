...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#new-order-modal" class="btn btn-primary shadow-md mr-2">Show More about appointment {{ $appointments->nom }}</a>
...
<div class="card">
    ...
    <div class="card-body">
        {!! QrCode::size(300)->generate("https://www.google.com/search?q=Appointment $appointments->nom $appointments->locale ") !!}
    </div>
</div>
