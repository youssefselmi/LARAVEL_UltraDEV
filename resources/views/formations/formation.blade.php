...
<h2 class="intro-y text-lg font-medium mt-10">Formations</h2>

<div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
<form class="edit-form" action="/addformation" method="GET" >

<button class="btn btn-primary shadow-md mr-2">Ajouter une formation</button>
</form>
...
<div class="head" style="display: block-flex; align-items: center">
    ...
    <div class="text-right">
        ...
        <form class="edit-form" action="/formationgrid" method="GET" >
...
<div
    ...
    >
        <img
            class="card-img-top"
            src="{{ 'storage/imgs/'.$formation['image'] }}"
            alt="formation photo"
        ...
        <div class="card-body">
            ...
            <div
                ...
                "
            >
                <a href="/formation" style="opacity : 0; width : 0; height : 0" disabled>Explorer plus</a>
                <div
    ...
    @endforeach @if (count($formations) == 0)
    <h4>Pas de formations pour le moment</h4>
    @endif
</div>
<div class="evenements-list-container">
    <table class="mb-0 table table-hover">
        <thead>
            ...
            <!--   //  <th>Session</th> -->
                <th>Description</th>
                <th>Mail du Formateur</th>
                <th>Nom du Formateur</th>
                <th>Profession du formateur</th>
                <th>localisation </th>
                <th>Prix</th>
                <th>Duree</th>
                <th>Actions</th>
...
height : 50px;
  ...
  @if($value->id==$formation["session_id"])
...
@endforeach
                ...
                <td>{{ $formation["mail_formateur"] }}</td>
                <td>{{ $formation["nom_formateur"] }}</td>
                <td>{{ $formation["formateur_profession"] }}</td>
                <td>{{ $formation["location_formation"] }}</td>
...
<form
                    ...
                    <a href="{{ url('/formationdetail/' . $formation->id) }}" title="View Formation"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
