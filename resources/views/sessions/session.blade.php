...
<h2 class="intro-y text-lg font-medium mt-10">Sessions</h2>

<div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
<form class="edit-form" action="/addsession" method="GET" >

<button class="btn btn-primary shadow-md mr-2">Ajouter une session</button>
</form>
<div class="dropdown">
...
<div
    ...
    <h4>Pas de session pour le moment</h4>
    @endif
</div>
...
<form
                        class="edit-form"
                        action="/session/{{ $session['id'] }}/modifiersession"
                        method="GET"
                    >
                        <button
                    ...
                    <form class="delete-form" action="/deletesession/{{$formation->id}}"method="POST">
                        @csrf @method('DELETE')
