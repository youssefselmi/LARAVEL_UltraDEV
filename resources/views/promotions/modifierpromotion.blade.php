        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                <form
                    ...
                    novalidate
                    method="POST"
                    action="/promotion/{{ $promotion->id }}"
                    enctype="multipart/form-data"
                    onsubmit="return checkDate()">
                    @csrf @method('PUT')
                    <div class="input-group">
                        <input value="{{$promotion->promo}}" id="crud-form-3" name="promo" type="text"
                               class="form-control" placeholder="Description Promo .." aria-describedby="input-group-1">
                        <div id="input-group-1" class="input-group-text">Promo description</div>
                    </div>
