            ...
            <div class="intro-y box p-5">
                ...
                >
                    ...
                    <div class="position-relative row form-group">
                        <label for="promo" class="col-sm-2 col-form-label">Promo Description </label>
                        <div class="input-group">
                            <input id="crud-form-3" name="promo" type="text" class="form-control"
                                   placeholder="Description du promotion .." aria-describedby="input-group-1">
                        </div>
