...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Promotions</h2>
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <form class="edit-form" action="/addpromotion" method="GET">
            <button class="btn btn-primary shadow-md mr-2">Ajouter Une Promotion</button>
        </form>
        <div class="dropdown">
                ...
                @foreach ($promotions as $service)
                    <tr>
                        ...
                        <td class="table-report__action w-56">
                            <form
                                class="edit-form"
                                action="/promotion/{{ $service['id'] }}/modifierpromotion"
                                method="GET"
                            >
                                <button
                            ...
                            <form class="delete-form" action="/deletepromotion/{{$service->id}}" method="POST">
                                @csrf @method('DELETE')
